...
fun AppearanceScreen(
    ...
    val items = listOf(
        ...
        SettingsWithoutKey.VISUAL_THEME_BROWSER,
...
fun createAppearanceSettings(context: Context) = listOf(
    Setting(
        context,
        SettingsWithoutKey.VISUAL_THEME_BROWSER,
        R.string.visual_theme_browser,
        R.string.visual_theme_browser_summary,
    ) { setting ->
        Preference(
            name = setting.title,
            description = setting.description,
            onClick = { SettingsDestination.navigateTo(SettingsDestination.VisualThemes) },
        )
    },
